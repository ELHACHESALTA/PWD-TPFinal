<?php
    ...
    foreach ($arregloMenu as $menu){
        ...
        if (($menu -> getObjMenu() -> getMedescripcion() == "gestionUsuarios") && ($menu -> getObjMenu() -> getMedeshabilitado() == NULL) && $rolActivo -> getIdrol() == $arregloObjMenuRol2[0] -> getObjRol() -> getIdrol()) {
            $permiso = true;
        }
    }
    if (!$permiso) {
